System.register(['angular2/core', '../models/route', '../utils/utils', '../google/directions.service', '../config/config', '@ngrx/store', '../reducers/track', '../reducers/details'], function(exports_1, context_1) {
    "use strict";
